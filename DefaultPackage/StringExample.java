...
public class StringExample {
	...
	public static void main(String[] args) {
        ...
        StringBuilder sb = new StringBuilder("St Pious X ");
     ...
     // 10. Get a substring from the StringBuilder
        ...
        int indexOfGeeks = sb.indexOf("Java");
        System.out.println("Index of 'Java': " + indexOfGeeks);
